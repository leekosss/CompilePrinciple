...
def printFirst(grammar):
    ...
    # first_sets['STATEMENTSEQUENCE'] = calculateFirst('STATEMENTSEQUENCE')
    # print("First(" + "STATEMENTSEQUENCE" + ")=" + str(first_sets["STATEMENTSEQUENCE"]))
# 打印Follow集
...
if __name__ == '__main__':
    ...
    print("len:", len(grammar['terminals']))
